...
{
    [self showMessage:msg image:[UIImage imageNamed:@"YXHStatusBar.bundle/success"]];
}
...
{
    [self showMessage:msg image:[UIImage imageNamed:@"YXHStatusBar.bundle/error"]];
}
